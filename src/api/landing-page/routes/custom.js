...
/**
 * custom landing-page router.
 */

const { createCoreRouter } = require("@strapi/strapi").factories;
const defaultRouter = createCoreRouter("api::landing-page.landing-page");
...
const myOverideRoutes = [
  {
    method: "GET",
    path: "/landing-pages/:page_name",
    handler: "api::landing-page.landing-page.findOne",
  },
];
